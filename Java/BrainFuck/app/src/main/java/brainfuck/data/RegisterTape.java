...
public class RegisterTape {
    ...
    /** Возвращает значение на ячейке. 
     * @return значение на ячейке, на которое указывает главный указатель. 
     */
    ...
    /** 
     * Изменяет значение на ячейке. 
     * @param value значение, которое будет изменено в ячейке на которую указывает главный указатель. 
     */
    ...
    /** 
     * Возвращает адрес ячейки в данной ленте. 
     * @return адрес ячейки на который указывает главный указатель. 
     */
    ...
    /** 
     * Изменяет адрес на ячейки в данной ленте. 
     * @param value новый адрес на ячейку в ленте. 
     * @throws IndexOutOfBoundsException при попытке изменить на адрес, не возможный в данной ленте. 
     */
